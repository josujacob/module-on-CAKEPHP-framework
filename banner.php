...
<h2> Banner </h2>  
    ...
    <div style="background:linear-gradient(to bottom,#00d2ff, #928dab); padding: 20px; color: black"  >
        <hr>
        <form action="banner2.php" method="post" enctype="multipart/form-data">
           <h3 style="float: left">Add an image</h3><br><br>
            <br><input type="hidden" name="MAX_FILE_SIZE" value="10000000">
            <input type="file" name="image" required/>
      
           <h3 style="float: left">Add a description</h3><br>
      

            <textarea class="col-md-12" rows="4" name="description" placeholder="Enter banner description....." required ></textarea>
       <br>  <input type="submit" value="Upload Image" name="upload">
        </form>
</div>
...
<tr>
   ...
   <td>  <img src="banner/<?php echo $row['image'];?>" width='200' height='200'></td>
  <td><?php echo $row["description"] ?></td>
  <td>

      <a onclick="return confirm('Are you sure you want to edit ???');" href="banner_edit.php?id=<?php echo $row['id']?>"><button>edit</button></a>

      <a onclick="return confirm('Are you sure you want to delete this entry????');" href="banner_delete.php?id=<?php echo $row['id']?>" ><button>delete</button></a> 
